...
function createRecipeCard(recipe) {
    ...
    const thumbImage = recipe.image || (typeof THUMB_IMAGES !== 'undefined' && THUMB_IMAGES[recipe.id] ? THUMB_IMAGES[recipe.id] : null) || "https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=800&auto=format&fit=crop";
    ...
    setTimeout(() => {
        ...
        if (matchedRecipes.length > 0) {
            ...
            resultHTML += matchedRecipes.map(recipe => {
                const thumbImage = recipe.image || (typeof THUMB_IMAGES !== 'undefined' && THUMB_IMAGES[recipe.id] ? THUMB_IMAGES[recipe.id] : null) || "https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=200&auto=format&fit=crop";
                return `
